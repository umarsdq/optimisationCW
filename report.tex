...
\author{CID: 02238728 (umar), 02211542, ...}
\date{\vspace{-1em}}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/mse_vs_degree.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/mse_vs_training_size_a.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/learned_function_a.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/mse_comparison.png}
\caption{MSE for varying polynomial degree, with and without gradient information)}
\label{fig:mse_comparison}
\end{figure}

Fixing the value of $n$ at the optimal value, Figure~\ref{fig:mse_vs_size_comp} shows how the MSE varies with the number of training points for both methods. As expected, more training data leads to better generalization. Figure~\ref{fig:learned_function_comp} compares the learned polynomial function at $n=9$ for both cases.

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/mse_vs_training_size_comparison.png}
\caption{MSE on validation data vs. number of training points (fixed $n=9$), with and without gradient information.}
\label{fig:mse_vs_size_comp}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/learned_function_comparison.png}
\caption{Comparison of learned polynomial functions at $n=9$.}
\label{fig:learned_function_comp}
\end{figure}

What we observe is that including gradient information leads to a model that not only achieves a lower validation error but also provides a visibly better fit to the underlying data, especially with fewer training points. The resulting function is smoother and more stable. This demonstrates that gradient information is a powerful tool for improving model accuracy and robustness, effectively providing more information about the function's shape at each data point.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/dynamic_optimisation_a.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.75\textwidth]{plots/dynamic_optimisation_b_states.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{plots/dynamic_optimisation_b_controls.png}
...
This approximation is used to make the $L_1$ norm differentiable for the optimization process. To determine the optimal learning rate, the gradient descent algorithm was performed for each of the 3 given cases for varying learning rates and a maximum of 5000 iterations. The cost ($\|x^2\|+\|y^2\|$) was found to converge, with an optimal learning rate of $1 \times 10^{-1}$.

\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{plots/learning_rate_comparison.png}
\caption{Variation of learning rate for...}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{plots/L1_controls.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{plots/L1_states.png}
