...
Fixing the value of $n$ at the optimal value, Figure~\ref{fig:mse_vs_size} shows how the MSE varies with the number of training points. As expected, more training data leads to better generalization. Figure~\ref{fig:learned_function} shows the learned polynomial function at $n=9$.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{plots/dynamic_optimisation_b_states.png}
